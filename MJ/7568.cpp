...
int main() {
//////////////////////////////////////////////
int nOfPeople; cin >> nOfPeople;
vector<pair<int, int>> specs(nOfPeople);
for (int n = 0; n < nOfPeople; n++) cin >> specs[n].first >> specs[n].second;
vector<int> ranks(nOfPeople,1);
for (int n = 0; n < nOfPeople; n++) {
    for (int p = 0; p < nOfPeople; p++) {
        if (specs[p].first > specs[n].first && specs[p].second > specs[n].second) ranks[n]++;
    }
    cout << ranks[n] << " ";
}
//////////////////////////////////////////////
