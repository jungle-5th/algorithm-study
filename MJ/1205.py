...
# 입력
# 첫째 줄에 N, 태수의 새로운 점수, 그리고 P가 주어진다. P는 10보다 크거나 같고, 50보다 작거나 같은 정수,
# N은 0보다 크거나 같고, P보다 작거나 같은 정수이다. 그리고 모든 점수는 2,000,000,000보다 작거나 같은 자연수 또는 0이다.
...
rank.reverse()
if (n - bisect.bisect_left(rank, s) < p): print(n-bisect.bisect_right(rank,s)+1)
else: print(-1)